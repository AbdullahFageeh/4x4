...
import { placesService, PlaceType, PLACE_CATEGORIES } from '../../services/placesService';
...
const styles = StyleSheet.create({
  ...
  marker: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingHorizontal: 12, paddingVertical: 6, borderRadius: 20 },
  markerText: { fontSize: 14 },
  markerLabel: { fontSize: 12, fontWeight: '500' },
  infoContainer: { flex: 1, padding: 16 },
  tripCard: { borderRadius: 16, borderWidth: 1, padding: 16, marginBottom: 16 },
  ...
  routeLine: { width: 2, height: 16, backgroundColor: '#ddd', marginLeft: 9 },
  actions: { flexDirection: 'row', gap: 12, marginTop: 16 },
  actionButton: { flex: 1, height: 48, borderRadius: 12, borderWidth: 1, alignItems: 'center', justifyContent: 'center' },
  actionText: { fontSize: 14, fontWeight: '600' },
  directionsCard: { borderRadius: 16, borderWidth: 1, padding: 16 },
