...
export function toMajor(minor, currency) {
  ...
  return new Decimal(minor).div(new Decimal(10).pow(currencyFraction(currency))).toNumber();
}
...
//# sourceMappingURL=currency_util.js.map