...
type Predicate = (value: string, creditCardNumber: string | undefined, supportedNetworks: CreditCardNetwork[] | undefined) => boolean;
export declare class FieldValidator {
     ...
     */
    visualValidate(value: string, creditCardNumber?: string, supportedNetworks?: CreditCardNetwork[]): string | null;
    /**
     ...
     */
    validate(value: string, creditCardNumber?: string, supportedNetworks?: CreditCardNetwork[]): string | null;
}
export {};
//# sourceMappingURL=field_validator.d.ts.map