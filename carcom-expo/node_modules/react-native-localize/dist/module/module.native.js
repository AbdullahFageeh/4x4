...
import NativeModule from "./specs/NativeRNLocalize.js";
import { findBestLanguageTagImpl } from "./utils.js";
...
export const usesAutoDateAndTime = () => NativeModule.usesAutoDateAndTime() ?? undefined;
export const usesAutoTimeZone = () => NativeModule.usesAutoTimeZone() ?? undefined;
export const findBestLanguageTag = languageTags => findBestLanguageTagImpl(languageTags, getLocales());
