...
export const BottomNav: React.FC = () => {
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-[#151412]/95 backdrop-blur-lg border-t border-[rgba(235,233,228,0.08)] pb-safe shadow-2xl">
              ...
              <div
                className={`p-1 transition-all ${
                  isActive
                    ...
                    : 'text-[#EBE9E4]/50 group-hover:text-[#EBE9E4]'
                }`}
              >
                <Icon className="w-5 h-5" />
              </div>
              <span
                className={`text-[11px] font-mono tracking-wider mt-0.5 whitespace-nowrap ${
                  isActive ? 'text-[#D4AF37] font-bold' : 'text-[#EBE9E4]/50'
                }`}
              >
                {tab.label}
              </span>
